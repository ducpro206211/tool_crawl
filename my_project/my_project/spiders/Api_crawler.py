...
def run_spiders(prompt):
    ...
    scrapy_project_path = "/Users/oraichain/Downloads/Tool_QA/my_project"
...
def search_and_return_result():
    try:
        ...
        if prompt:
            ...
            output_data = load_json_from_file('/Users/oraichain/Downloads/Tool_QA/my_project/output.json')
